...
export default function Home() {
  ...
  return (
    <main className={`flex min-h-screen flex-col items-center justify-between ${styles.homeContainer} ${styles.blurEffect}`}>
      {/* Header */}
      <header className="bg-green-700 w-full h-24 flex justify-between items-center mb-22">
        {/* Logo */}
        <div className="flex items-center ml-8">
          <img src="/logo/narslogopure.png" alt="Logo" className="h-28 w-auto" /> {/* Replace 'your-logo-image.jpg' with your actual logo image */}
        </div>
        {/* Burger Menu Icon */}
        ...
        <div className="mr-24 text-white text-xl font-semibold gap-4 flex items-center space-x-6">
          ...
          <a href="/Signup" className="bg-yellow-500 hover:bg-emerald-600 text-white px-4 py-2 rounded-md transition-colors duration-300 ease-in-out">Sign Up</a>
        </div>
      </header>
       ...
       <div className="flex flex-col items-center text-black space-x-16">
        <div className="flex flex-row items-center justify-center w-full">
          ...
          Welcome to <span className="text-yellow-400" style={{ textShadow: "1px 1px 1px black" }}>Nar's</span> <span className="text-green-600" style={{ textShadow: "1px 1px 1px gray" }}>School Supplies</span>
            </h1>
            ...
            <div className="flex space-x-4 mt-4">
              <a href="/Signin" className="flex items-center bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-3 rounded-md transition-colors duration-300 ease-in-out">
